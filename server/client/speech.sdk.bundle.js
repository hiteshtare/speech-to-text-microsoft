...
var SpeechConnectionFactory = /** @class */ (function () {
    function SpeechConnectionFactory() {
        ...
        this.Create = function (config, authInfo, connectionId) {
            ...
            var queryParams = {
                cid: "32b8bdd1-5ad2-4c7d-8f12-28f3890a76b3",
        ...
        this.host = "wss://westus.stt.speech.microsoft.com"; // Host for custom speech endpoint
    }
    Object.defineProperty(SpeechConnectionFactory.prototype, "Host", {
        get: function () {
            return Exports_2.Storage.Local.GetOrAdd("Host", this.host);
        },
        enumerable: true,
        configurable: true
    });
